      ...
      {comments && (
        <div className="mainDiv">
          ...
          <div className="post-top-part">
            ...
            ></i>
            <i style={{ marginLeft: "150px" }} className="fa-2x">
              Comments
            </i>
                ...
                >
                  <Link to={`/user/${each.by.username}`}>
                    <img
                      ...
                      height="35"
                      src={
                        each.by.dp || require("../../images/profile-pic.jpg")
                      }
                      alt="profile pic"
                    />
                  </Link>
                  <h6 className="post-comment-username">
                    <Link to={`/user/${each.by.username}`}>
          ...
          >
            <Link to={`/user/${username}`}>
              <img
                className="post-profile-pic newCommentImg"
                width="35"
                height="35"
